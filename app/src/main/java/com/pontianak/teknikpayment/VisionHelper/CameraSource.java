...
package com.pontianak.teknikpayment.VisionHelper;
...
public class CameraSource {
  ...
  //private int ctipe=CAMERA_FACING_FRONT;
  ...
  public CameraSource(Activity activity, GraphicOverlay overlay, int ctipe) {
